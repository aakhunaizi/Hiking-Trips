...
const trips = [
  {
    ...
    caption: "Visit Norway's best landscapes",
    ...
    slideImage:
      "https://strapi-images-prod.s3.us-west-1.amazonaws.com/northern-lights-skagsanden-beach-lofoten-norway-shutterstock_1120772963_db36cd9e1b.jpeg",
    city: "Oslo, Norway",
    difficulty: "hard",
    length: 59,
    rating: (
  ...
  },
  {
    ...
    caption: "An amazing diversity of scenery",
    ...
    slideImage:
      "https://wildlandtrekking.com/content/uploads/2020/03/Iceland-Winter-Wonders-Tour-image1-1.jpg",
  ...
  },
  {
    ...
    caption: "Suitable for a broad range of ages and abilities",
  ...
  },
  {
    ...
    caption: "A must do for all hiking enthusiasts",
    ...
    slideImage:
      "https://prod-upp-image-read.ft.com/561f60ce-f49a-11e8-ae55-df4bf40f9d0d",
  ...
  },
  {
    ...
    caption: "An epic adventure in the ancient capital city",
    ...
    slideImage:
      "https://wildlandtrekking.com/content/uploads/2020/03/image1-5.jpg",
    city: "Hanoi, Vietnam",
    difficulty: "easy",
    length: 56,
    rating: (
  ...
  },
  {
    ...
    caption: "A lodge-based tour highlighting Cusco",
    ...
    slideImage: "https://i.ytimg.com/vi/07V7hnHkyF8/maxresdefault.jpg",
    city: "Cusco, Peru",
    difficulty: "medium",
    length: 32,
    rating: (
